    ...
    private Claims extractAllClaims(String token) {
        try {
            return Jwts.parserBuilder()
                    ...
                    .getBody();
        } catch (io.jsonwebtoken.UnsupportedJwtException | io.jsonwebtoken.security.SignatureException e) {
            // Fallback for Supabase tokens signed with ES256 or unknown keys
