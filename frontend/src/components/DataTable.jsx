  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center bg-white/5 border border-white/10 rounded-full px-4 py-2 w-72 focus-within:ring-2 focus-within:ring-primary/50 transition-shadow">
      ...
      <div className="flex items-center justify-between mt-4 text-sm text-foreground/60">
        ...
        <div className="flex items-center space-x-2">
          <button className="p-1 rounded-md hover:bg-white/10 disabled:opacity-50"><ChevronLeft className="w-4 h-4" /></button>
          <button className="p-1 rounded-md hover:bg-white/10 disabled:opacity-50"><ChevronRight className="w-4 h-4" /></button>
        </div>
      </div>
    </div>
  );
