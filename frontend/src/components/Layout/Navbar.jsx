  ...
  return (
    <header className="h-16 md:h-20 bg-background/70 backdrop-blur-xl border-b border-black/10 dark:border-white/10 sticky top-0 z-20 flex items-center justify-between px-4 md:px-8 gap-4 transition-colors duration-300">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
              ...
              >
                ...
                <div className="max-h-80 overflow-y-auto custom-scrollbar">
                  {notifications.length === 0 ? (
                    ...
                    notifications.map(n => (
                      <div key={n.id} className="p-4 border-b border-black/5 dark:border-black/5 dark:border-white/5 hover:bg-black/5 dark:hover:bg-white/5 transition-colors flex gap-3">
        ...
        <Link to="/profile" className="flex items-center gap-3 pl-3 border-l border-black/10 dark:border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 p-1 pr-3 rounded-full transition-colors group cursor-pointer">
